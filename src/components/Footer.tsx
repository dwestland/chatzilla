      ...
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            Empower your website with Chattastic - the AI-driven customer service chat bot for health, fitness, and beauty sites. Boost engagement and promote your services seamlessly.
            </div>
