...
export default async function Home() {
  ...
  return (
    <main>
      ...
      >
        Chattastic provides smart, conversational chatbots to turn your website
        visitors into customers. Our AI-powered chatbots engage visitors 24/7 to
        promote your services and book appointments.
      </SectionTitle>
      ...
      >
        You have your own custom dashboard to adjust your companies details in
